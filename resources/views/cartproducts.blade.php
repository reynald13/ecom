            ...
            <table class="table table-condensed">
                ...
                <tr>
                    <td class="cart_product">
                        <a href=""><img src="product_images/'.$item['data']['image']" width="100" height="100" alt=""></a>
                    </td>
                    ...
                    <td class="cart_quantity">
                        <div class="cart_quantity_button">
                            ...
                            <input class="cart_quantity_input" type="text" name="quantity" value="{{$item['quantity']}}" autocomplete="off"
                                   size="2">
